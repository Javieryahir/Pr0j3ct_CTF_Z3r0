        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
                ...
                <a href="#"
                    ...
                    <img src="./assets/img/challengeImg/petcybersecurity_hacked.jpg" className="hidden"></img>
                    <div
                ...
                <a href="#"
                    ...
                    <img src="./assets/img/challengeImg/congresocyber_hacked.jpg" className="hidden"></img>
                ...
                <a href="#"
                    ...
                    <img src="./assets/img/challengeImg/teamcyber_hacked.jpg" className="hidden"></img>
                ...
                <a href="#"
                    ...
                    <img src="./assets/img/challengeImg/ctfcyber_hacked.jpg" className="hidden"></img>
