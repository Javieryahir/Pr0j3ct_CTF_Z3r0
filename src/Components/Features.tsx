...
function Features() {
    return <div className="bg-slate-900 text-white font-[sans-serif]">
        <div className="max-w-6xl mx-auto py-16 px-4">
            <h2 className="text-4xl font-extrabold text-center mb-16">Decubre El Mundo de La Ciberseguridad</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-md:max-w-md mx-auto">
                <div className="bg-slate-800 rounded-lg overflow-hidden shadow-lg">
                    <div className="p-6">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Conoce</h3>
                        <p className="text-gray-500 text-sm">Las Nuevas Las Tecnologias y Herramientas Relacionadas a la ciberseguridad</p>
                    </div>
                </div>
                <div className="bg-slate-800 rounded-lg overflow-hidden shadow-lg">
                    <div className="p-6">
                        ...
                        <p className="text-gray-500 text-sm">Con personas apasionadas con la ciberseguridad y Mejora tus habilidades</p>
                    </div>
                </div>
                <div className="bg-slate-800 rounded-lg overflow-hidden shadow-lg">
                    <div className="p-6">
                        ...
                        <p className="text-gray-500 text-sm">Con las dinamicas entretenidas que tenemos para ti para que fortalezcas tus habilidades</p>
                    </div>
                </div>
            </div>
        </div>
